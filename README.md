...
```mermaid
graph TD
    Start[Start Here] --> Status{Experience Level?}

    Status -->|Beginner| Beg[Foundations]
    Status -->|Intermediate| Int[Build & Deploy]
    Status -->|Advanced| Adv[Scale & Secure]

    Beg --> Beg1[1. Get Name.com Domain]
    Beg1 --> Beg2[2. Host on GitHub Pages]
    Beg2 --> Beg3[3. Use GitHub Copilot]

    Int --> Int1[1. Deploy to DigitalOcean]
    Int1 --> Int2[2. Use JetBrains IDEs]
    Int2 --> Int3[3. Set up CI/CD Actions]

    Adv --> Adv1[1. Monitor with Sentry]
    Adv1 --> Adv2[2. Secure with 1Password]
    Adv2 --> Adv3[3. Scale on Azure/AWS]
```
...
```mermaid
graph TD
    Start[Comece Aqui] --> Status{Nível de Experiência?}

    Status -->|Iniciante| Beg[Fundação]
    Status -->|Intermediário| Int[Construção e Deploy]
    Status -->|Avançado| Adv[Escala e Segurança]

    Beg --> Beg1[1. Garanta seu Domínio Name.com]
    Beg1 --> Beg2[2. Hospede no GitHub Pages]
    Beg2 --> Beg3[3. Use o GitHub Copilot]

    Int --> Int1[1. Deploy na DigitalOcean]
    Int1 --> Int2[2. Use IDEs JetBrains]
    Int2 --> Int3[3. Configure CI/CD Actions]

    Adv --> Adv1[1. Monitore com Sentry]
    Adv1 --> Adv2[2. Segurança com 1Password]
    Adv2 --> Adv3[3. Escala no Azure/AWS]
```
...
[![GitHub or Go Home](.github/thumbnail.jpg)](https://www.youtube.com/watch?v=i21-AjPpiFc)
